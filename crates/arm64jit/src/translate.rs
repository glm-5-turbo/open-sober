                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                    Ok(())
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Inst::SimdCmhs { rd, rn, rm, lanes } => {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                for i in 0..lanes {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    buf.mov_ri64(RDI, 0xffff_ffff_ffff_ffff);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    buf.mov_ri64(RDX, 0);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    buf.cmov_rr64(0x43, RDI, RDX); // cmovae: ones iff Vn>=Vm
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    buf.mov_store32(RBX, slot(rd) + off, RDI);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Ok(())
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        Inst::SimdCmgt { rd, rn, rm, lanes, dword } => {
                                                                                                                                                                                                                                                                                                                                                                            // cmgt Vd.T, Vn.T, Vm.T: per lane all-ones if Vn[i]>Vm[i] (SIGNED), else 0.
                                                                                                                                                                                                                                                                                                                                                                            let slot = |r: u8| crate::jit::VECTOR_BASE + (r as i32) * 16;
                                                                                                                                                                                                                                                                                                                                                                            for i in 0..lanes {
                                                                                                                                                                                                                                                                                                                                                                                let off = (i as i32) * if dword { 8 } else { 4 };
                                                                                                                                                                                                                                                                                                                                                                                if dword { buf.mov_load64(RAX, RBX, slot(rn)+off); buf.mov_load64(RCX, RBX, slot(rm)+off); }
                                                                                                                                                                                                                                                                                                                                                                                else { buf.mov_load32(RAX, RBX, slot(rn)+off); buf.mov_load32(RCX, RBX, slot(rm)+off); }
                                                                                                                                                                                                                                                                                                                                                                                buf.cmp_rr64(RAX, RCX);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                buf.mov_ri64(RDI, 0xffff_ffff_ffff_ffff);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                buf.mov_ri64(RDX, 0);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                buf.cmov_rr64(0x4e, RDI, RDX); // cmovle: RDI=0 when !(Vn>Vm); keeps ones when Vn>Vm (cmovg was inverted: sets 0 ON greater)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            if dword { buf.mov_store64(RBX, slot(rd)+off, RDI); } else { buf.mov_store32(RBX, slot(rd)+off, RDI); }
                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                            Ok(())
                                                                                                                                                                                                                                                                                                                                                                        }
