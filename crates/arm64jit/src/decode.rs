...
pub enum Inst {
    ...
    // ---- SIMD bitwise NOT (two-input mvn alias, single-source): mvn Vd.16B/8B, Vn ----
        ...
        SimdHighNarrow { rd: u8, rn: u8, rm: u8, dst_esize: u8, sub: bool, round: bool, q: bool },
...
//        5=sha256h,6=sha1su0,7=sha1su1,8=sha256su0,9=sha256su1) ----
    ...
    // ---- SIMD widening multiply: smull/umull Vd.T, Vn.T, Vm.T (src*U res) ----
        ...
        // unsigned=bit28; res_esize 4(.4s from .4h) or 8(.2d from .2s) by bit22; q=bit30.
         // acc=mlal(bit14 set 0x8000); sub=smlsl/umlsl (byte2 0xa0: bit13 sets into 0x2000).
        SimdMull { rd: u8, rn: u8, rm: u8, res_esize: u8, unsigned: bool, q: bool, acc: bool, sub: bool },
        ...
        // ---- SIMD widening multiply smull/umull & smlal/umlal (0x0f00_c000/8000 gate) ----
                                                                                                                                                                                        ...
                                                                                                                                                                                        // got res=4, and plain smull/umull accumulated. Fixed here.)
                                                                                                                                                                                        {
                                                                                                                                                                                            ...
                                                                                                                                                                                            if (mullgt == 0x0e00_c000 || mullgt == 0x0e00_8000)
                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                            // smlsl/umlsl Vd.T, Vn.T, Vm.T: accumulate-SUBTRACT the widening product.
                                                                                                                                                                                                                                                                                                                            // Same 0x0e00_8000 family but byte2 bit13 (0x2000) is SET (0xa0) vs mlal
                                                                                                                                                                                                                                                                                                                            // (0x80). The strict (insn&0x0000_3800)==0 guard above excludes these
                                                                                                                                                                                                                                                                                                                            // (0xa0 & 0x3800 = 0x2000), so they reach here.
                                                                                                                                                                                                                                                                                                                            if mullgt == 0x0e00_8000 && (insn & 0x0000_2000) != 0
                                                                                                                                                                                                                                                                                                                                && (insn & 0x0000_1000) == 0 // bit12 clear (fmls etc safe)
                                                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                                                let rm = ((insn >> 16) & 0x1f) as u8;
                                                                                                                                                                                                                                                                                                                                let rn = ((insn >> 5) & 0x1f) as u8;
                                                                                                                                                                                                                                                                                                                                let rd = (insn & 0x1f) as u8;
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if teq {
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                return Inst::SimdCmEq { rd, rn, rm, lanes, esize };
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                let hb0 = (insn >> 24) & 0xff;
                                                                                                                                                                                                                                                                                                let hb2 = (insn >> 8) & 0xff;
                                                                                                                                                                                                                                                                                                if (hb0 == 0x0e || hb0 == 0x2e || hb0 == 0x4e || hb0 == 0x6e) && ((hb2 & 0xe0) == 0x40 || (hb2 & 0xe0) == 0x60)
                                                                                                                                                                                                                                                                                                                                                    && (insn & 0x400) == 0        // bit10=0 marks three-different (addhn/subhn); 3-same min/max set it
                                                                                                                                                                                                                                                                                                                                                    && (insn & 0x200_000) != 0 { // bit21 SET for all addhn/subhn/raddhn/rsubhn; EXT (same byte1 0x40) clears it
...
mod fp16_scalar_and_gate_regressions {
    ...
    fn fp16_threesame_add_sub_mul_decode() {
        ...
        // SIMD add/sub-high-narrow Q=1: addhn2 v5.8h=0x4e604205 (real), raddhn2
        // v5.8h=0x6e604205 (real, round), rsubhn2 v7.8h=0x6e666227. EXT v1.16b
        // (0x6e004001, same byte1 0x40) must NOT become HighNarrow.
        assert!(matches!(decode_op(0x4e604205),
            Inst::SimdHighNarrow { rd: 5, rn: 16, rm: 0, dst_esize: 2, sub: false, round: false, q: true }),
            "addhn2 got {:?}", decode_op(0x4e604205));
        assert!(matches!(decode_op(0x6e604205),
            Inst::SimdHighNarrow { rd: 5, rn: 16, rm: 0, dst_esize: 2, sub: false, round: true, q: true }),
            "raddhn2 got {:?}", decode_op(0x6e604205));
        assert!(matches!(decode_op(0x6e666227),
        ...
        // widening subtract-accumulate: smlsl v0.4s = 0x0e62a020 (sub=true), umlsl = 0x2e62a020,
        // smlsl2 = 0x4e62a020 (q), real smlsl2 v7 = 0x4e63a007, smlsl v20 = 0x0e60a0d4.
        assert!(matches!(decode_op(0x0e62a020),
            Inst::SimdMull { rd: 0, rn: 1, rm: 2, res_esize: 4, unsigned: false, q: false, acc: true, sub: true }),
            "got {:?}", decode_op(0x0e62a020));
        assert!(matches!(decode_op(0x2e62a020),
            Inst::SimdMull { res_esize: 4, unsigned: true, q: false, acc: true, sub: true, .. }));
        assert!(matches!(decode_op(0x4e62a020),
            Inst::SimdMull { res_esize: 4, unsigned: false, q: true, acc: true, sub: true, .. }));
        assert!(matches!(decode_op(0x4e63a007),
            Inst::SimdMull { rd: 7, rn: 0, rm: 3, res_esize: 4, unsigned: false, q: true, acc: true, sub: true }));
        assert!(matches!(decode_op(0x0e60a0d4),
            Inst::SimdMull { rd: 20, rn: 6, rm: 0, res_esize: 4, unsigned: false, q: false, acc: true, sub: true }),
            "got {:?}", decode_op(0x0e60a0d4));
        // negatives must NOT match: smull (0x0e62c020, acc=false), smlal (0x0e628020, sub=false),
        // fmul 2d (0x4ee1dc00), frecpe (0x4ea1d820).
        assert!(!matches!(decode_op(0x0e62c020), Inst::SimdMull { sub: true, .. }), "smull not sub");
        assert!(!matches!(decode_op(0x0e628020), Inst::SimdMull { sub: true, .. }), "smlal not sub");
