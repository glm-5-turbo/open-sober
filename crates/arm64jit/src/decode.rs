                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if let Some((lanes, esize, teq)) = match ce {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if teq {
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                return Inst::SimdCmEq { rd, rn, rm, lanes, esize };
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    // ---- SIMD table lookup: tbl Vd.16B, {Vn..Vn+N}, Vm (multi-reg form) ----
                                                                                                                                                                                                                                                                                                                                                                            // Gate (insn & 0xfff0_fc00)==0x4e00_0000; tbx sets 0x1000. len = tables-1.
                                                                                                                                                                                                                                                                                                                                                                            if (insn & 0xfff0_fc00) == 0x4e00_0000 {
                                                                                                                                                                                                                                                                                                                                                                                let vn = ((insn >> 5) & 0x1f) as u8;
                                                                                                                                                                                                                                                                                                                                                                                let vd = (insn & 0x1f) as u8;
                                                                                                                                                                                                                                                                                                                                                                                let vm = ((insn >> 16) & 0x1f) as u8;
                                                                                                                                                                                                                                                                                                                                                                                let tbx = (insn & 0x1000) != 0;
                                                                                                                                                                                                                                                                                                                                                                                let n_tables = (((insn >> 13) & 0x3) + 1) as u8;
                                                                                                                                                                                                                                                                                                                                                                                return Inst::Tbl { rd: vd, rn: vn, rm: vm, tbx, n_tables };
                                                                                                                                                                                                                                                                                                                                                                            }
